...
(set-face-attribute 'default nil :font "DejaVu Sans Mono-10" :height efs/default-font-size)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "DejaVu Sans Mono-10" :height efs/default-font-size)
...
[[https://magit.vc/][Magit]] is the best Git interface I've ever used.  Common Git operations are easy to execute quickly using Magit's command panel system. Evil-magit was put in to the evil-collection, so is no longer necessary to be explicitly included.
